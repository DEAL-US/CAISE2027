...
for the BPM2025 / CAISE 2027 conference. The data model and the behaviour was tailored
...
## Flow in the BPM2025 / CAISE 2027 website
...
The rest of the files are for `pnpm`, `eslint`, `TypeScript` or other utilities and are not relevant
